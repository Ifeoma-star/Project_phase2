...
| 8   | interaction | Start all four blobs cycling up and down when Power On clicked                | major  | Clicking Power On activates the cycling animation that moves all four wax blobs continuously through the lamp.                   | C4           |
