...
| 3   | visual      | Display Randomize button                                                                                           | minor  | Without the Randomize button, users have no way to cycle through the preset word list.                        | None         |
| 4   | visual      | Display Download SVG button                                                                                        | minor  | Without the Download SVG button, users cannot export the generated neon sign as a file.                       | None         |
...
| 7   | visual      | Render the neon sign text with a pink glow effect                                                                  | major  | A visible glow effect distinguishes the output as a neon sign rather than plain text on a dark background.    | C1           |
...
| 9   | state       | Retain the displayed neon sign unchanged on the canvas between Randomize clicks                                    | major  | Sign stability between clicks gives users time to view and download the current sign before generating a new one. | C1           |
