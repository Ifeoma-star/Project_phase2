...
| 2   | content     | Show the word "OPEN" glowing in pink neon on the canvas on initial load                                            | major  | The pre-loaded sign confirms the generator produces visible output before the user interacts.                  | C1           |
| 3   | visual      | Display Randomize button                                                                                           | major  | The Randomize button triggers the neon sign update with a new word from the preset list.                      | None         |
| 4   | visual      | Display Download SVG button                                                                                        | major  | The Download SVG button allows users to save the current neon sign as an SVG file.                            | None         |
...
| 7   | state       | Render the neon sign text with a pink glow effect                                                                  | major  | The pink glow effect is the defining visual output of the neon sign generator.                                | C6           |
