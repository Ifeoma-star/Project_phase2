...
| 3   | visual      | Display Randomize button                                                                                           | minor  | The Randomize button is a prerequisite for the interaction in C6; the action itself is verified there.        | None         |
| 4   | visual      | Display Download SVG button                                                                                        | minor  | The Download SVG button is a prerequisite for the interaction in C8; the action itself is verified there.     | None         |
