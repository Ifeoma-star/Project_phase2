...
| --- | ----------- | ----------------------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| 1   | visual      | Display tall lamp container with rounded base and rounded cap                 | major  | The lamp container provides the enclosed vertical space through which wax blobs travel during the simulation.                     | None         |
